Shader3D Start
{
    ...
    uniformMap:{
        //System Uniform 
        u_Tintcolor : {type: Color, default:[1, 1, 1, 1]},
        u_texture : {type: Texture2D, default: "white", options: { define: "DIFFUSEMAP" }},
    ...
    defines: {
        TINTCOLOR:{type:bool, default:true, private:false},
        ADDTIVEFOG:{type:bool, default:true, private:false},
    }
    shaderPass:[ 
        {
            pipeline:Forward,
